      ...
      {selectedItems.length === 2 && (
        <div>
          <ModalAdvanced
            ...
            bodyClassName="max-w-[350px] sm:max-w-full md:max-h-full max-h-[400px] w-[430px] sm:w-[600px] md:w-[700px] lg:w-[1050px] bg-white p-10 rounded-lg relative z-10 content h-[500px] overflow-y-auto overflow-x-hidden"
          >
