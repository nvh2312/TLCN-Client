...
const ProductList = ({ data, handlePageClick, page, totalPage }) => {
  ...
  return (
    <>
      <div className="w-[98vw] mt-10 md:mt-15 lg:mt-20">
      ...
      {selectedItems.length === 2 && (
        <div className="max-w-[100vw]">
          <ModalAdvanced
            ...
            bodyClassName="max-w-[350px] max-h-[400px] sm:max-w-full md:max-h-full w-[430px] sm:w-[600px] md:w-[700px] lg:w-[1050px] bg-white rounded-lg h-[500px] relative z-10 content overflow-y-auto overflow-x-hidden "
          >
            <div className=" p-10">
